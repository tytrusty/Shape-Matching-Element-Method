...
\begin{table*}[h]
  ...
  \begin{tabular}{l c c c c c c c c c c}
   ...
   \textbf{Cantilever (soft)}       & 564 & Jelly & $1 e^3$ & $1e10^6$& 0.45 & $2.53 e^{-2}$ & $4.45 e^{-3}$ & $4.78 e^{-1}$ & $1.86 e^{-1}$ & $1.20 e^{0}$ \\
   ...
   \textbf{Chicken}                 & 1773 & Rubber & $1.27 e^3$ & $1 e^4$ & 0.47 & $9.19 e^{-1}$ & $2.31 e^{-2}$ & $3.38 e^{0}$ & $1.91 e^{0}$ & $1.08 e^{1}$ \\
   \textbf{Starship}                & 750 & Steel & $8 e^3$ & $2 e^{11}$ & 0.32 & $6.78 e^{-2}$ & $1.52 e^{-2}$ & $8.50 e^{-1}$ & $9.52 e^{-2}$ & $6.95 e^{-1}$ \\
   \textbf{Astronauts}              & ? & ? & ? & ? & ? & ? & ? & ? & ? & ? \\
   \textbf{Tire}                    & ? & Rubber/Steel & $2 e^3$ / $3 e^3$ & $1 e^6$ / $7 e^9$ & 0.47 / 0.35 & ? & ? & ? & ? & ? \\
   \hline
  \end{tabular}
  \end{center}
...
Our algorithm is not dependent on triangulating the boundary, and an ideal alternative would be using a path tracer that directly accepts NURBS geometry.
...
This is similar to Discontinous Galerkin approaches but in SEM this behavior is emerges from the kinematic model, rather than from additional flux terms~\cite{kaufmann2009flexible}.

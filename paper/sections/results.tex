...
For collision detection and handling, we use the triangulation to detect inter-penetrations at the beginning of every iteration, and attempt to move the collided vertex out of its collision surface using a spring-like penalty force, similar to \cite{10.1145/3355089.3356486, 10.1145/2010324.1964932}.

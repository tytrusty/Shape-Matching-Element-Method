...
\dave{mention we focus on animation ... lots of work to validate this for engineering applications}
...
Our method allows simulation of such input directly with a variety of constitutive models and time integration schemes,
and is compatible with standard methods for collision resolution. 

...
\revise{In future work we also intend to explore using robust solvers or orthogonal bases for the shape matching step itself.} \ty{more can be said here I suppose. I tried pinv() on the beam, which surprisingly worked, but it's just unpredictable since it should still fail on my very basic 2D box example. Haven't done much experimentation beyond this though, so I just write future work}

...
\begin{figure}[h]
    ...
    \caption{Distance weight as a function of primary and total ray length with cutoff distance 50 (left). Here we use different colors to denote different parts (right).}

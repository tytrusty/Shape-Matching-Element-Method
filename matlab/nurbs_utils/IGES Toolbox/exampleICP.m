...
% 
% 
% [Bergstr�m & Edlund (2016) 2017]
% 
% Bergstr�m, P. and Edlund, O. (2016) 2017, �Robust registration of surfaces using a refined iterative closest point algorithm 
% with a trust region approach�, Numerical Algorithms, doi: 10.1007/s11075-016-0170-3
% 
% 
% [Bergstr�m 2016]
% 
% Bergstr�m, P. 2016, �Reliable updates of the transformation in the iterative closest point algorithm�,

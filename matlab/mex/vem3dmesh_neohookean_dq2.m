% VEM2DMESH_NEOHOOKEAN_DQ Compute the gradient of Neohookean potential
...
%                  monomial vectors
%   dF_dq   M by (2*2 * 2*N) gradient of deformation gradient (F) with
%                            respect to the elements' configuration
%                            vectors (N is the # of points for this
%                            element)
%   dM_dX   M by (k*2) gradient of the monomial basis vector with respect
